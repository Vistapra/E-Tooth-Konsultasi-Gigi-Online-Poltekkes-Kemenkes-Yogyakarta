                    ...
                    <form method="POST" action="{{ route('admin.doctor.update', $doctor) }}"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                                :value="old('email', $doctor->user->email)" required autocomplete="email" />
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-gray-600 mt-2">If changing, password must be at least 8 characters long, contain uppercase and lowercase letters, numbers, and symbols.</p>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="spesialis" class="block mt-1 w-full" type="text" name="spesialis"
                                :value="old('spesialis', $doctor->spesialis)" required autocomplete="spesialis" />
